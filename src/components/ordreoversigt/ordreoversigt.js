...
export default function Basket() {
  ...
  const totalPrice = state.vipTicket * vipTicketPrice + state.basicTicket * basicTicketPrice + state.tent3 * tent3Price + state.tent2 * tent2Price + state.greenCamping * greenCamingPrice + (itemInBasket ? 99 : 0); // Tilføjer booking fee, hvis der er noget i kurven
