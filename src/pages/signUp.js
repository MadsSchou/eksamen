          ...
          <form className={styles["login_form"]} onSubmit={(e) => handleLogIn(e)}>
            <div className={styles["field"]}>
              ...
              <div className={styles[["input-container"]]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="darkgrey" class="bi bi-envelope-fill" viewBox="0 0 16 16">
            ...
            <div className={styles["field"]}>
              <label className={styles["white"]} htmlFor="password"></label>
              <div className={styles[["input-container"]]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="darkgrey" class="bi bi-lock-fill" viewBox="0 0 16 16">
        ...
        <div className={styles["signup_col"]}>
          ...
          <form className={styles["signUp_form"]} onSubmit={(e) => handleSignUp(e)}>
            <div className={styles["field"]}>
              ...
              <div className={styles["input-container"]}>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="darkgrey" class="bi bi-person-fill" viewBox="0 0 16 16">
            ...
            <div className={styles["field"]}>
              ...
              <div className={styles["input-container"]}>
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Gentag password" />
              </div>
            </div>
